            ...
            <div className="vote-box" key={i}>
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src = `${process.env.PUBLIC_URL}/img/kanye.png`;
                }}
              />
